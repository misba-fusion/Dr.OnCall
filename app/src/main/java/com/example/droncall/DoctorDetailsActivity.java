...
public class DoctorDetailsActivity extends AppCompatActivity {
    ...
    private String[][] doctor_details1 =
            {
                    ...
                    {"Doctr Name: Swapnil Kale", "Hospital Address: Pune", "Exp: 8yrs", "Mobile No:8898989898", "300"},
    ...
    private String[][] doctor_details2 =
            {
                    ...
                    {"Doctor Name: Swati Pawar", "Hospital Address: Nigdi", "Exp: 15yrs", "Mobile No:7898989898", "988"},
    ...
    private String[][] doctor_details3 =
            {
                    {"Doctor Name: Seema Patil", "Hospital Address: Pimpri", "Exp: 4yrs", "Mobile No: 9898989898", "280"},
                    ...
                    {"Doctor Name: Vishal Deshmukh", "Hospital Address: Chinchwad", "Exp: 6yrs", "Mobile No:9898800000", "500"},
    ...
    private String[][] doctor_details4 =
            {
                    ...
                    {"Doctor Name: Prasad Pawar", "Hospital Address: Niadi", "Exp: 15yrs", "Mobile No:7898989898", "900"},
    ...
    private String[][] doctor_details5 =
            {
                    ...
                    {"Doctor Name: Pamkai Pawar", "Hospital Address: Nigdi", "Exp: 15yrs", "Mobile No:7898989898", "1980"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<doctor_details.length; i++)
        {
            ...
            item.put("line5", "Cons Fees: " + doctor_details[i][4]+"Tk");
            list.add(item);
        }
